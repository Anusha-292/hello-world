   ...
   stage ('SAST') {
      steps {
         ...
         // sh 'sonar-scanner -version' 
          //sh 'mvn -version'
         sh -x 'sudo /data/sonar-scanner-4.8.0.2856-linux/bin/sonar-scanner -Dsonar.projectKey=devsecops -Dsonar.sources=. -Dsonar.host.url=http://34.100.252.84:9000 -Dsonar.token=sqa_2810d9cd6a44cf8f277282e3536d8f300738f6b3'
